		...
		SeekBar.OnSeekBarChangeListener
{
	...
	public static boolean nota = false;
		...
		public void handleMessage( final Message msg )
		{
			switch( msg.what )
			{
				...
				case MSG_DISABLE_DISCONNECT:
					...
					break;
				case MSG_SHOW_TOAST:
					Toast.makeText(RFIDHostActivity.this, (String) msg.obj, Toast.LENGTH_LONG).show();
					break;
	...
	public void finalizarLeituraInventario(View view){
		...
		if(!parametro.isVersaoTeste() || parametro.isVersaoTeste()){
			...
			if(parametro !=  null){
				...
				url += aplicacao;
				url += (!nota ? "inserir-leituras" : "inserir-leituras-nota");
